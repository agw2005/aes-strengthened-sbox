  ...
  return (
    <nav className="flex gap-16 justify-center">
      ...
      >
        ...
        <p className="leading-none text-xs md:text-sm">Original paper</p>
      </a>
      <a
      ...
      >
        ...
        <p className="leading-none text-xs md:text-sm">Source code</p>
      </a>
      <a
        className="text-white h-12 fill-white hover:fill-red-400 hover:text-red-400 flex flex-col justify-center text-center"
      ...
      >
        ...
        <p className="leading-none text-xs md:text-sm">Support me</p>
      </a>
    </nav>
  );
};
